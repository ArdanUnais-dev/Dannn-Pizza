...
<body class="bg-gray-900 p-6 text-gray-200">
    <div class="container mx-auto mt-8 p-6 bg-gray-800 rounded-xl shadow-lg">
        ...
        <form method="GET" action="orders.php" class="mb-6 flex">
            ...
            <button type="submit" class="ml-2 bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-300 focus:outline-none focus:ring-2 focus:ring-yellow-500">Cari</button>
        </form>
