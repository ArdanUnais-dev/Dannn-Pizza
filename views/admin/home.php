...
<body class="bg-green-500 text-white font-poppins">
  <nav class="fixed top-0 left-0 right-0 z-50 bg-orange-800 bg-opacity-80 py-4 px-6 flex justify-between items-center border-b border-gray-700">
    <a href="#" class="text-2xl font-bold italic text-white">Dannn<span class="text-yellow-500">Pizza</span></a>
  ...
  <div class="absolute right-10 top-20 cursor-pointer">
    <button id="modal-button" class="py-2 px-4 bg-yellow-500 hover:bg-orange-600 text-l rounded-lg">Tambah Menu</button>
  </div>
