...
<body class="bg-gradient-to-r from-blue-600 to-purple-600 font-sans leading-normal tracking-normal text-gray-200">
    <div class="max-w-md mx-auto mt-16 p-8 bg-gradient-to-r from-blue-500 to-green-600 rounded-xl shadow-2xl">
        ...
        <div class="mt-8 text-center">
            <a href="#" class="w-full bg-yellow-600 text-white font-semibold py-3 px-6 rounded-lg hover:bg-orange-600 transition duration-300 focus:outline-none focus:ring-2 focus:ring-yellow-500">
                Update Profile
            </a>
        </div>
    </div>
